            ...
            <main className='mx-auto max-w-7xl'>
                <section className='relative pt-28 min-h-[80vh]'>
                    ...
                    <div className='relative z-10 container mx-auto px-2 lg:pl-35'>
                        <h1 class="text-white font-extrabold text-4xl sm:text-6xl leading-tight">
                            Empower your business <br />with <span class="bg-gradient-to-r from-amber-500 via-red-500 to-pink-600 bg-clip-text text-transparent">top-class software development</span>
                        </h1>
                    </div>
                </section>
                        ...
                        <div className="text-center">
                            ...
                            <div className='flex flex-col md:justify-center md:items-center gap-4 bg-white p-5 rounded-md'>
                                ...
                                <NavLink to='#' className='bg-[#131426] border-1 border-[#131426] py-2 px-5 sm:px-3 text-white flex items-center justify-center gap-2 sm:w-min rounded hover:bg-[rgba(19,20,38,0.8)] hover:border-[rgba(19,20,38,0.8)] transition-colors duration-200'>
                                    <span className='sm:w-14 text-xs font-bold pl-2 sm:pl-0 '>See more</span><span><MoveRight size={18} /></span>
                                </NavLink>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='mx-auto max-w-7xl px-2 sm:px-4 lg:px-6'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-2 p-1'>
                            {serviceBoxesData.map((service) => (
                                <div
                                    key={service.id}
                                    className='bg-white rounded-lg flex flex-col-reverse md:flex-row items-center justify-between gap-2 p-4 md:p-8'
                                >
                                    <div className='flex flex-col gap-5 flex-3/5'>
                                        ...
                                        <NavLink to='#' className='bg-[#131426] border-1 border-[#131426] py-2 px-5 sm:px-3 text-white flex items-center justify-center gap-2 sm:w-min rounded hover:bg-[rgba(19,20,38,0.8)] hover:border-[rgba(19,20,38,0.8)] transition-colors duration-200'>
                                            <span className='sm:w-14 text-xs font-bold pl-2 sm:pl-0 '>Let's Chat</span><span><MoveRight size={18} /></span>
                                        </NavLink>
                                    </div>
                                    <div className=''>
                        ...
                        <div className="flex flex-col justify-end py-16 pr-5 bg-gradient-to-b from-[#f7efe3] to-[#f7e4e3] text-[#131426]">
                            ...
                            <div className="mt-10">
                                <NavLink to='#' className='bg-[#131426] border-1 border-[#131426] py-2 px-5 text-white flex items-center justify-between gap-2 w-full md:w-min rounded hover:bg-[rgba(19,20,38,0.8)] hover:border-[rgba(19,20,38,0.8)] transition-colors duration-200'>
                                    <span className='md:w-14 text-xs font-bold pl-2 sm:pl-4 md:pl-0'>Let's Chat</span><span><MoveRight size={18} className='' /></span>
                                </NavLink>
                            </div>
                        </div>
                    </div>
                ...
                <section className="flex justify-center pb-20" style={{ background: "linear-gradient(to right, #5322e7, #2153f6)" }}>
                    <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:px-6 flex flex-col md:flex-row text-white">
                        <div className="flex flex-col justify-between md:w-1/2 pt-20 md:h-[512px]">
                            ...
                            <div className='hidden md:block sm:text-2xl text-shadow-black text-black/30 font-semibold '>
                                Synergy Algo
                            </div>
                        </div>
                        ...
                        <div className="md:w-1/2 mt-[85px]">
                            <form>
                                <div className="space-y-4">
                                    <div className="flex gap-4">
                                        <div className="w-full">
                                            ...
                                            <input
                                                type="text"
                                                id="first_name"
                                                className="w-full bg-transparent border border-[#7795ff] rounded-md px-2 py-[6px] md:p-3"
                                            />
                                        </div>
                                        <div className="w-full">
                                    ...
                                    <button className="flex items-center justify-center gap-2 w-full md:w-60 rounded-lg bg-white text-[#131426] font-semibold md:font-bold md:text-lg text-sm px-0 py-2  hover:bg-white/90 transition cursor-pointer">
                                        Send request
